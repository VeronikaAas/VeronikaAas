		...
		<section className="text-center mb-12">
			...
			<div className="grid md:grid-cols-3 gap-6">
				{projects.map((project) => (
					<div
						key={project.id}
						className="bg-white rounded-lg p-4 shadow-md border border-red-300 hover:shadow-lg transition"
					>
						...
						<p className="text-sm text-red-700 mb-2">{project.description}</p>
						<Link
							to={project.link}
							className="inline-block bg-neutral-100 text-red-600 px-4 py-1 rounded-full border border-red-300 shadow hover:bg-red-200 hover:text-red-800 transition text-sm"
						>
							See more
						</Link>
					</div>
